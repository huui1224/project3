...
// ====== 0) 여기만 너 값으로 바꾸면 됨 ======
const SHEETS_ENDPOINT = "https://script.google.com/macros/s/AKfycbwI8imhQyyuL3dUXZAunMtYZ5Tcuys4Fw6yxKDFlX9b0a-sqRGv4seaQAqna8W0DbNpzg/exec";
...
const ITEMS = [
  ...
  { id:"H6", domain:"도움요청/정서조절", text:"“어떤 도움이 필요해요”라고 구체히 말해볼 수 있어요.", reverse:false, weight:1, intent:"구체적 요청" },
];
